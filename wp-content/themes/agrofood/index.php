...
if( is_search() ){
	agrofood_breadcrumbs_title(true, true, esc_html__( 'Search Results for: ', 'agrofood' ) . get_search_query());
}
?>
			...
			<?php	
				if( have_posts() ):
					...
					echo '<div class="alert alert-error">';
						echo '<h3>'.esc_html__('Sorry. There are no posts to display!', 'agrofood').'</h3>';
						echo '<p>'.esc_html__('Try researching for something else.', 'agrofood').'</p>';
					echo '</div>';
