...
$opt_name = 'agrofood_theme_options';
...
$args = array(
	...
	'menu_title'           => esc_html__( 'Theme Options', 'agrofood' ),
	'page_title'           => esc_html__( 'Theme Options', 'agrofood' ),
	...
	'global_variable'      => 'agrofood_theme_options',
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'General', 'agrofood' )
	,'id'               => 'general-tab'
	,'desc'             => ''
	,'icon'             => 'el el-home'
...
/*** Color Scheme Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Color Scheme', 'agrofood' )
	,'id'               => 'color-scheme-tab'
	,'desc'             => ''
	,'icon'             => 'el el-brush'
...
/*** Typography Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Typography', 'agrofood' )
	,'id'               => 'typography-tab'
	,'desc'             => ''
	,'icon'             => 'el el-font'
...
/*** Header Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Header', 'agrofood' )
	,'id'               => 'header-tab'
	,'desc'             => ''
	,'icon'             => 'el el-lines'
...
/*** Footer Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Footer', 'agrofood' )
	,'id'               => 'footer-tab'
	,'desc'             => ''
	,'icon'             => 'el el-lines'
...
/*** Menu Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Menu', 'agrofood' )
	,'id'               => 'menu-tab'
	,'desc'             => ''
	,'icon'             => 'el el-th-list'
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Portfolio Details', 'agrofood' )
...
/*** WooCommerce Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'WooCommerce', 'agrofood' )
	,'id'               => 'woocommerce-tab'
	,'desc'             => ''
...
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Shop/Product Category', 'agrofood' )
...
/*** Product Details Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Product Details', 'agrofood' )
...
/*** Custom Code Tab ***/
Redux::setSection( $opt_name, array(
	'title'             => esc_html__( 'Custom Code', 'agrofood' )
	,'id'               => 'custom-code-tab'
	,'desc'             => ''
	,'icon'             => 'el el-edit'
