...
if( !class_exists('TS_Products_Widget') ){
	class TS_Products_Widget extends WP_Widget {
		...
		function widget( $args, $instance ) {
			...
			$lazy_load = !wp_doing_ajax() && function_exists('agrofood_get_theme_options')?agrofood_get_theme_options('ts_prod_lazy_load'):false;
			$placeholder_img_src = $lazy_load && function_exists('agrofood_get_theme_options')?agrofood_get_theme_options('ts_prod_placeholder_img')['url']:'';
						...
						<?php endif; ?>
							<li>
								<a class="ts-wg-thumbnail" href="<?php echo esc_url( get_permalink($product->get_id()) ); ?>" title="<?php echo esc_attr( $product->get_title() ); ?>">
									<?php  
										if( $show_label && function_exists( 'agrofood_template_loop_product_label' ) ){
											agrofood_template_loop_product_label();
										}
								...
								<div class="ts-wg-meta">
									<?php 
										if( $show_brand && function_exists('agrofood_template_loop_brands') ) {
											agrofood_template_loop_brands();
										}
									?>
									<?php
									if( $show_categories && function_exists('agrofood_template_loop_categories') ){ 
										agrofood_template_loop_categories(); 
									}
									?>
