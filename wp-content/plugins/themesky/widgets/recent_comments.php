						...
						<?php endif; ?>
							<li>
								...
								<div class="comment-meta">
									...
									<?php if( $show_author ): ?>
									<span class="author">
										<?php esc_html_e('by ', 'themesky'); ?><a href="<?php echo (get_comment_author_url() == '')?'javascript: void(0)':get_comment_author_url(); ?>" rel="external nofollow"><?php echo esc_html($comment->comment_author); ?></a>
									</span>
									<?php endif; ?>
								</div>
								
								<?php if( $show_comment && function_exists('agrofood_string_limit_words') ): ?>
								<blockquote class="comment-body"><?php echo agrofood_string_limit_words(wp_strip_all_tags(get_comment_text()), 15); ?></blockquote>
								<?php endif; ?>
